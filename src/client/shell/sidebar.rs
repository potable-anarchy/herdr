...
pub(crate) fn render_collapsed_sidebar(
        ...
        .enumerate()
    {
        ...
        let selection_background = workspace_selection_background(row_palette);
        let active_background =
            workspace_active_background(row_palette, selected_workspace_id.is_some());
        if selected {
        ...
        let number_style = if selected {
            ...
            Style::default().fg(row_palette.text).bg(active_background)
